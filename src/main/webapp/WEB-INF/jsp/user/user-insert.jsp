							...
							<div class="am-u-sm-12 am-u-md-9">
								<form class="am-form am-form-horizontal">
									<div class="am-form-group">
										...
										登录名 / LoginName</label>
										<div class="am-u-sm-9">
											<input type="text" id="user-name" placeholder="登录名 / LoginName" name="url" class="LoginName">
											<small>输入登录名 / LoginName</small>
										</div>
									</div>
									...
									<div class="am-form-group">
										...
										/ UserName</label>
										<div class="am-u-sm-9">
											<input type="text" id="user-name" placeholder="用户姓名 / UserName" name="PathName" class="UserName"> <small>输入用户姓名 / UserName</small>
										</div>
									</div>
									<div class="am-form-group">
										...
										/ PassWord</label>
										<div class="am-u-sm-9">
											<input type="text" id="user-name" placeholder="登录密码 / PassWord" name="PathName" class="PassWord"> <small>登录密码 / PassWord</small>
										</div>
									</div>
									...
									<div class="am-form-group">
										...
										/ Age</label>
										<div class="am-u-sm-9">
											<input type="text" id="user-name" placeholder="年龄 / Age" name="PathName" class="Age"> <small>年龄 / Age</small>
										</div>
									</div>
									...
									<div class="am-form-group">
										...
										/ Phone</label>
										<div class="am-u-sm-9">
											<input type="text" id="user-name" placeholder="电话号码 / Phone" name="PathName" class="Phone"> <small>电话号码 /
											Phone</small>
										</div>
									</div>
									...
									<div class="am-form-group">
										...
										/ department</label>
										<div class="am-u-sm-9">
											<input type="text" id="user-name" placeholder="所属部门 / department" name="PathName" class="department"> <small>所属部门 / department</small>
										</div>
									</div>
