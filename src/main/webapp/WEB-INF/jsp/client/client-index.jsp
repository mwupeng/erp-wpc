							...
							<div class="am-u-sm-12 am-u-md-6">
								<div class="am-btn-toolbar">
									<div class="am-btn-group am-btn-group-xs">
										<a href="/client/ClientInsert"><button type="button" class="am-btn am-btn-default am-btn-success" id="ClientInsert">
									...
									<table class="am-table am-table-striped am-table-hover table-main">
										<thead>
											<tr>
												...
												<th class="table-type">客户来源</th>
												<th class="table-type">联系人</th>
												<th class="table-type">联系人性别</th>
												<th class="table-type">联系人年龄</th>
												<th class="table-type">客户等级</th>
												<th class="table-author am-hide-sm-only">联系人电话</th>
												<th class="table-title">创建时间</th>
												<th class="table-set">操作</th>
											</tr>
										</thead>
										<tbody>
											<c:forEach items="${sessionScope.clientlist }" var="list">
												<tr>
													...
													<c:if test="${list.source == 1 }">
														<td>媒体宣传</td>
													</c:if>
													<c:if test="${list.source == 2 }">
														<td>招标伙伴</td>
													</c:if>
													<td>${list.contact }</td>
													<c:if test="${list.contactsex == 0 }">
														<td>男</td>
													</c:if>
													<c:if test="${list.contactsex == 1 }">
														<td>女</td>
													</c:if>
													<td>${list.contactage }</td>
													<c:if test="${list.clientgrade == 0 }">
														<td>超级会员</td>
													</c:if>
													<c:if test="${list.clientgrade == 1 }">
														<td>钻石会员</td>
													</c:if>
													<c:if test="${list.clientgrade == 2 }">
														<td>会员</td>
													</c:if>
