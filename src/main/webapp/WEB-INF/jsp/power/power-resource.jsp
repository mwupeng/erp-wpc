	...
	<header class="am-topbar am-topbar-inverse admin-header">
		...
		<div class="am-collapse am-topbar-collapse" id="topbar-collapse">
			...
			<ul
				...
				<li class="am-dropdown" data-am-dropdown data-am-dropdown-toggle>
					<a class="am-dropdown-toggle tpl-header-list-link"
					href="javascript:;"> <span class="tpl-header-list-user-nick"><sec:authentication
		...
		<div class="tpl-left-nav tpl-left-nav-hover">
			...
			<div class="tpl-left-nav-list">
				<ul class="tpl-left-nav-menu">
					<li class="tpl-left-nav-item"><a href="/index"
						class="nav-link active"> <i class="am-icon-home"></i> <span>首页</span>
					</a></li>
					<sec:authorize access="hasRole('0')">
						<li class="tpl-left-nav-item"><a href="javascript:;"
							class="nav-link tpl-left-nav-link-list"> <i
								class="am-icon-wpforms"></i> <span>权限管理</span> <i
								class="am-icon-angle-right tpl-left-nav-more-ico am-fr am-margin-right tpl-left-nav-more-ico-rotate"></i>
						</a>
							<ul class="tpl-left-nav-sub-menu" style="display: block;">
								<li><a href="/power/resource"> <i
										class="am-icon-angle-right"></i> <span>资源管理</span>
								</a> <a href="/user/user"> <i class="am-icon-angle-right"></i>
										<span>角色管理</span>
								</a> <a href="/section/index"> <i class="am-icon-angle-right"></i>
										<span>部门管理</span>
								</a></li>
							</ul></li>
					</sec:authorize>
					<sec:authorize access="hasRole('0')">
						<li class="tpl-left-nav-item"><a href="javascript:;"
							class="nav-link tpl-left-nav-link-list"> <i
								class="am-icon-wpforms"></i> <span>人事管理</span> <i
								class="am-icon-angle-right tpl-left-nav-more-ico am-fr am-margin-right tpl-left-nav-more-ico-rotate"></i>
						</a>
							<ul class="tpl-left-nav-sub-menu" style="display: block;">
								<li><a href="form-amazeui.html"> <i
										class="am-icon-angle-right"></i> <span>人事考核</span>
					...
					<sec:authorize access="hasRole('0')">
						<li class="tpl-left-nav-item"><a href="javascript:;"
							class="nav-link tpl-left-nav-link-list"> <i
								class="am-icon-wpforms"></i> <span>财务管理</span> <i
								class="am-icon-angle-right tpl-left-nav-more-ico am-fr am-margin-right tpl-left-nav-more-ico-rotate"></i>
						</a>
							<ul class="tpl-left-nav-sub-menu" style="display: block;">
								<li><a href="form-amazeui.html"> <i
										class="am-icon-angle-right"></i> <span>财务信息</span>
								</a> <a href="form-line.html"> <i class="am-icon-angle-right"></i>
										<span>生产货单</span>
								</a> <a href="form-line.html"> <i class="am-icon-angle-right"></i>
										<span>销售订单</span>
					...
					<sec:authorize access="hasRole('0')">
						<li class="tpl-left-nav-item"><a href="javascript:;"
							class="nav-link tpl-left-nav-link-list"> <i
								class="am-icon-wpforms"></i> <span>船务管理</span> <i
								class="am-icon-angle-right tpl-left-nav-more-ico am-fr am-margin-right tpl-left-nav-more-ico-rotate"></i>
						</a>
							<ul class="tpl-left-nav-sub-menu" style="display: block;">
								<li><a href="form-amazeui.html"> <i
										class="am-icon-angle-right"></i> <span>订单信息</span>
								</a> <a href="form-line.html"> <i class="am-icon-angle-right"></i>
										<span>货流状态 </span>
								</a></li>
							</ul></li>
					...
					<sec:authorize access="hasRole('0')">
						<li class="tpl-left-nav-item"><a href="javascript:;"
							class="nav-link tpl-left-nav-link-list"> <i
								class="am-icon-wpforms"></i> <span>仓库管理</span> <i
								class="am-icon-angle-right tpl-left-nav-more-ico am-fr am-margin-right tpl-left-nav-more-ico-rotate"></i>
						</a>
							<ul class="tpl-left-nav-sub-menu" style="display: block;">
								<li><a href="form-amazeui.html"> <i
										class="am-icon-angle-right"></i> <span>生产计划</span>
								</a> <a href="form-line.html"> <i class="am-icon-angle-right"></i>
										<span>采购计划 </span>
								</a> <a href="form-line.html"> <i class="am-icon-angle-right"></i>
										<span>货物信息 </span>
					...
					<sec:authorize access="hasRole('0')">
						<li class="tpl-left-nav-item"><a href="javascript:;"
							class="nav-link tpl-left-nav-link-list"> <i
								class="am-icon-wpforms"></i> <span>业务管理</span> <i
								class="am-icon-angle-right tpl-left-nav-more-ico am-fr am-margin-right tpl-left-nav-more-ico-rotate"></i>
						</a>
							<ul class="tpl-left-nav-sub-menu" style="display: block;">
								<li><a href="form-line.html"> <i
										class="am-icon-angle-right"></i> <span>销售订单 </span>
								</a> <a href="form-line.html"> <i class="am-icon-angle-right"></i>
										<span>销售业绩 </span>
								</a></li>
							</ul></li>
					...
					<sec:authorize access="hasRole('0')">
						<li class="tpl-left-nav-item"><a href="javascript:;"
							class="nav-link tpl-left-nav-link-list"> <i
								class="am-icon-wpforms"></i> <span>监控信息</span> <i
								class="am-icon-angle-right tpl-left-nav-more-ico am-fr am-margin-right tpl-left-nav-more-ico-rotate"></i>
						</a>
							<ul class="tpl-left-nav-sub-menu" style="display: block;">
								<li><a href="form-line.html"> <i
										class="am-icon-angle-right"></i> <span>Durid </span>
								</a> <a href="form-line.html"> <i class="am-icon-angle-right"></i>
										<span>日志信息</span>
								</a></li>
							</ul></li>
					...
					<sec:authorize access="hasRole('0')">
						<li class="tpl-left-nav-item"><a href="javascript:;"
							class="nav-link tpl-left-nav-link-list"> <i
								class="am-icon-wpforms"></i> <span>客户信息</span> <i
								class="am-icon-angle-right tpl-left-nav-more-ico am-fr am-margin-right tpl-left-nav-more-ico-rotate"></i>
						</a>
							<ul class="tpl-left-nav-sub-menu" style="display: block;">
								<li><a href="form-line.html"> <i
										class="am-icon-angle-right"></i> <span>客户管理 </span>
								</a> <a href="form-line.html"> <i class="am-icon-angle-right"></i>
										<span>客户地址</span>
								</a> <a href="form-line.html"> <i class="am-icon-angle-right"></i>
										<span>客户订单</span>
						...
						<div class="am-u-sm-12 am-u-md-6">
							<div class="am-btn-toolbar">
								<div class="am-btn-group am-btn-group-xs">
									<a href="/power/ResourceInsert"><button type="button"
								...
								<table
									...
									<thead>
										<tr>
											...
											<th class="table-title">URL路径</th>
											<th class="table-type">路径所属</th>
											<th class="table-type">类别</th>
											<th class="table-author am-hide-sm-only">开发者</th>
									...
									<tbody>
										<c:forEach items="${sessionScope.list }" var="list">
											<tr>
												...
												<td><a href="#">${list.url }</a></td>
												<td>${list.pathname }</td>
												<td>${list.type }</td>
												<td class="am-hide-sm-only">${list.developer }</td>
												<td class="am-hide-sm-only">${list.creationtime }</td>
												<td class="am-hide-sm-only">${list.modificationtime }</td>
												<td>
													<div class="am-btn-toolbar">
														<div class="am-btn-group am-btn-group-xs">
															<a href='/power/Exit?id=${list.id }'><input
																type="button" class="am-btn am-btn-default am-btn-xs "
																value="编辑" /></a> <a><input type="button"
																class="am-btn am-btn-default am-btn-xs" value="删除"
																onclick="del(${list.id })" /></a>
									...
									<div class="am-fr">
										<ul class="am-pagination tpl-pagination">
											<c:if test="${page.pageNum > 1 }">
												<li><a href="/power/resource?pageNo=1">«</a></li>
											</c:if>

											<c:if
												test="${(page.pageNum == 1) && (page.pageNum < page.pages) }">
												<c:forEach var="i" begin="1" end="${page.pages }">

													<c:if test="${page.pageNum == 1 }">
														<li class="am-active"><a
															href="/power/resource?pageNo=${i }">${i }</a></li>
													</c:if>

												</c:forEach>
												<li><a href="/power/resource?pageNo=${page.pages }">»</a>
												</li>
											</c:if>
											<c:if
												test="${(page.pageNum > 1) && (page.pageNum <= page.pages)}">
