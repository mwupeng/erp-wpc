	...
	<div class="tpl-page-container tpl-page-header-fixed">
					...
					<sec:authorize access="hasRole('0')">
						<li class="tpl-left-nav-item"><a href="javascript:;"
							...
							<ul class="tpl-left-nav-sub-menu" style="display: block;">
								...
								</a> <a href="/user/user"> <i class="am-icon-angle-right"></i> <span>角色管理</span>
		...
		<div class="tpl-content-wrapper">
			<ol class="am-breadcrumb">
				...
				<li><a href="#">权限管理</a></li>
				<li><a href="/power/resource">资源管理</a></li>
					...
					<div class="am-g tpl-amazeui-form">
						...
						<div class="am-u-sm-12 am-u-md-9">
							<form class="am-form am-form-horizontal">
								<div class="am-form-group">
									<label for="user-name" class="am-u-sm-3 am-form-label">
										路径 / URL</label>
									<div class="am-u-sm-9">
										<input type="text" id="user-name" placeholder="路径/ URL"
											name="url" class="url" value="${list[0].url }" /> <small>输入路径地址</small>
									</div>
								</div>

								<div class="am-form-group">
									<label for="user-name" class="am-u-sm-3 am-form-label">路径所属
										/ PathBelongs</label>
									<div class="am-u-sm-9">
										<input type="text" id="user-name"
											placeholder="输入所属管理 / PathBelongs" name="PathName"
											class="PathName" value="${list[0].pathname }"> <small>输入所属管理</small>
									</div>
								</div>
								...
								<div class="am-form-group">
									...
									<div class="am-u-sm-9">
										<input type="text" id="user-name"
											placeholder="开发者 / developer" name="developer"
											class="developer" value="${list[0].developer }"> <small>输入开发者名称</small>
									</div>
								</div>
							...
							<div class="am-modal am-modal-alert" tabindex="-1" id="my-error">
								<div class="am-modal-dialog">
									<div class="am-modal-hd">注意!</div>
									<div class="am-modal-bd">数据更新失败</div>
									<div class="am-modal-footer">
										<span class="am-modal-btn">确定</span>
									</div>
								</div>
							...
							<div class="am-modal am-modal-alert" tabindex="-1"
								...
								<div class="am-modal-dialog">
									<div class="am-modal-hd">注意!</div>
									<div class="am-modal-bd">数据为空,请重新填写</div>
									<div class="am-modal-footer">
										<span class="am-modal-btn">确定</span>
									</div>
								</div>
