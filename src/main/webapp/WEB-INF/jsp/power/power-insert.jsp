							...
							<li class="tpl-left-nav-item">
								...
								<ul class="tpl-left-nav-sub-menu" style="display: block;">
									<li>
										...
										<a href="/user/user"> <i class="am-icon-angle-right"></i>
											<span>角色管理</span>
										</a>
							...
							<div class="am-u-sm-12 am-u-md-9">
								<form class="am-form am-form-horizontal">
									<div class="am-form-group">
										...
										路径 / URL</label>
										<div class="am-u-sm-9">
											<input type="text" id="user-name" placeholder="路径/ URL" name="url" class="url"> <small>输入路径地址</small>
										</div>
									</div>
									...
									<div class="am-form-group">
										...
										/ PathBelongs</label>
										<div class="am-u-sm-9">
											<input type="text" id="user-name" placeholder="输入所属管理 / PathBelongs" name="PathName" class="PathName"> <small>输入所属管理</small>
										</div>
									</div>
									...
									<div class="am-form-group">
										...
										开发者 / developer</label>
										<div class="am-u-sm-9">
											<input type="text" id="user-name" placeholder="开发者 / developer" name="developer" class="developer"> <small>输入开发者名称</small>
										</div>
									</div>
