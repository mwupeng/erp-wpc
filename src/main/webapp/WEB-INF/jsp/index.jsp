	...
	<header class="am-topbar am-topbar-inverse admin-header">
		...
		<div class="am-collapse am-topbar-collapse" id="topbar-collapse">
			...
			<ul
				...
				<li class="am-dropdown" data-am-dropdown data-am-dropdown-toggle>
					<a class="am-dropdown-toggle tpl-header-list-link"
					href="javascript:;"> <span class="tpl-header-list-user-nick">
							<sec:authentication property="name" />
					</span><span class="tpl-header-list-user-ico"> <img
							src="assets/img/user01.png">
					</span>
				</a>
				...
				<ul class="tpl-left-nav-menu">
					...
					<sec:authorize access="hasRole('0')">
						<li class="tpl-left-nav-item"><a href="javascript:;"
							...
							<ul class="tpl-left-nav-sub-menu" style="display: block;">
								<li><a href="/client/index"> <i
										class="am-icon-angle-right"></i> <span>客户管理 </span>
								</a><a href="/clientaddress/index"> <i class="am-icon-angle-right"></i>
										<span>客户地址</span>
								</a><a href="/salesorder/index"> <i class="am-icon-angle-right"></i>
										<span>客户订单</span>
								</a></li>
							</ul></li>
					</sec:authorize>
					...
					<div class="tpl-portlet">
						<div class="tpl-portlet-title">
							<div class="tpl-caption font-green ">
								<i class="am-icon-cloud-download"></i> <span> 业绩率 </span>
							</div>
							<div class="actions">
					...
					<div class="tpl-portlet">
						<div class="tpl-portlet-title">
							<div class="tpl-caption font-red ">
								<i class="am-icon-bar-chart"></i> <span> 动态资料</span>
							</div>
							<div class="actions">
								<ul class="actions-btn">
						...
						<div class="tpl-scrollable">
							<div class="number-stats">
								<div class="stat-number am-fl am-u-md-6">
									<div class="title am-text-right">最大金额</div>
