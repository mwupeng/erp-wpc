							...
							<div class="am-u-sm-12 am-u-md-9">
								<form class="am-form am-form-horizontal">
									<div class="am-form-group">
										...
										创建人 / Creation</label>
										<div class="am-u-sm-9">
											<input type="text" id="user-name" placeholder="创建人 / Creation" value='${address[0].creation}' class="creation"> <small>输入创建人
											/ Creation</small>
										</div>
									</div>
									...
									<div class="am-form-group">
										...
										/ creatioName</label>
										<div class="am-u-sm-9">
											<input type="text" id="user-name" placeholder="创建人姓名 / CreatioName" class="creatioName" value='${address[0].creationame}'>
											<small>输入创建人姓名 / creatioName</small>
										</div>
									</div>
									<div class="am-form-group">
										<label for="user-name" class="am-u-sm-3 am-form-label">收货人
										/ Consignee</label>
										<div class="am-u-sm-9">
											<input type="text" id="user-name" placeholder="收货人 / Consignee" class="consignee" value='${address[0].consignee}'> <small>收货人
											/ Consignee</small>
										</div>
									</div>

									<div class="am-form-group">
										<label for="user-name" class="am-u-sm-3 am-form-label">收货人电话
										/ ConsigneePhone</label>
										<div class="am-u-sm-9">
											<input type="text" id="user-name" placeholder="收货人电话 / Phone" value='${address[0].consigneephone}' class="Phone"> <small>收货人电话 / ConsigneePhone</small>
										</div>
									</div>

									<div class="am-form-group">
										<label for="user-name" class="am-u-sm-3 am-form-label">收货人详细地址
										/ Address</label>
										<div class="am-u-sm-9">
											<input type="text" id="user-name" placeholder="收货人详细地址 / Address" class="address" value='${address[0].address}'> <small>收货人详细地址
											/ Address</small>
										</div>
									</div>
									...
									<div class="am-form-group">
										...
										/ Remark</label>
										<div class="am-u-sm-9">
											<input type="text" id="user-name" placeholder="备注 / Remark" class="remark" value='${address[0].remark}'> <small>备注 / emark</small>
										</div>
									</div>
								...
								<div class="am-modal am-modal-alert" tabindex="-1" id="my-error">
									<div class="am-modal-dialog">
										<div class="am-modal-hd">注意!</div>
										<div class="am-modal-bd">数据失败失败，请联系管理员</div>
										<div class="am-modal-footer">
											<span class="am-modal-btn">确定</span>
										</div>
									</div>
			...
			$('#sumbitInsert')
				.on(
					...
					function() {
						...
						var ma = name.replace(/[^0-9]/g, "");
						if((Creation == null || Creation == "") ||
							(CreatioName == null || CreatioName == "") ||
