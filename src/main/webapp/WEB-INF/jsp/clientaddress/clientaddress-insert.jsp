							...
							<div class="am-u-sm-12 am-u-md-9">
								<form class="am-form am-form-horizontal">
									<div class="am-form-group">
										...
										创建人 / Creation</label>
										<div class="am-u-sm-9">
											<input type="text" id="user-name" placeholder="创建人 / Creation" class="creation">
											<small>输入创建人 / Creation</small>
										</div>
									</div>
									...
									<div class="am-form-group">
										...
										/ creatioName</label>
										<div class="am-u-sm-9">
											<input type="text" id="user-name" placeholder="创建人姓名 / CreatioName" name="PathName" class="creatioName"> <small>输入创建人姓名 / creatioName</small>
										</div>
									</div>
									<div class="am-form-group">
										...
										/ Consignee</label>
										<div class="am-u-sm-9">
											<input type="text" id="user-name" placeholder="收货人 / Consignee" class="consignee"> <small>收货人 / Consignee</small>
										</div>
									</div>
									...
									<div class="am-form-group">
										...
										<div class="am-u-sm-9">
											<input type="text" id="user-name" placeholder="收货人电话 / Phone" class="Phone"> <small>收货人电话 /
											ConsigneePhone</small>
										</div>
									</div>
									...
									<div class="am-form-group">
										...
										/ Address</label>
										<div class="am-u-sm-9">
											<input type="text" id="user-name" placeholder="收货人详细地址 / Address" class="address"> <small>收货人详细地址 / Address</small>
										</div>
									</div>
