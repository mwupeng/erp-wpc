							...
							<div class="am-u-sm-12 am-u-md-6">
								<div class="am-btn-toolbar">
									<div class="am-btn-group am-btn-group-xs">
										<a href="/power/ResourceInsert"><button type="button" class="am-btn am-btn-default am-btn-success" id="ResourceInsert">
							...
							<div class="am-u-sm-12">
								<form class="am-form">
									<table class="am-table am-table-striped am-table-hover table-main">
										...
										<tbody>
											<c:forEach items="${sessionScope.sectionlist }" var="list">
												<tr>
													...
													<td class="am-hide-sm-only">${list.createtime }</td>
													<td>
														<div class="am-btn-toolbar">
															<div class="am-btn-group am-btn-group-xs">
																<a href='/section/Exit?id=${list.id }'><input type="button" class="am-btn am-btn-default am-btn-xs " value="编辑" /></a>
										...
										<div class="am-fr">
											<ul class="am-pagination tpl-pagination">
												<c:if test="${page.pageNum > 1 }">
													<li>
														<a href="/section/index?pageNo=1">«</a>
													</li>
												</c:if>
												...
												<c:if test="${(page.pageNum == 1) && (page.pageNum < page.pages) }">
													<c:forEach var="i" begin="1" end="${page.pages }">
														...
														<c:if test="${page.pageNum == 1 }">
															<li class="am-active">
																<a href="/section/index?pageNo=${i }">${i }</a>
															</li>
														</c:if>

													</c:forEach>
													<li>
														<a href="/section/index?pageNo=${page.pages }">»</a>
													</li>
												</c:if>
												<c:if test="${(page.pageNum > 1) && (page.pageNum <= page.pages)}">
													<c:forEach var="i" begin="1" end="${page.pages }">
