							...
							<form class="am-form am-form-horizontal">
								<div class="am-form-group">
									<label for="user-name" class="am-u-sm-3 am-form-label">
										编号 / ID</label>
									<div class="am-u-sm-9">
										<input type="text" id="user-name" placeholder='${list[0].id }'
											disabled class="sectionid" />
									</div>
								</div>
								...
								<div class="am-form-group">
									...
									<div class="am-u-sm-9">
										<input type="text" id="user-name"
											placeholder="输入部门名称 / SectionName" class="SectionName"
											value="${list[0].department }"> <small>输入部门</small>
									</div>
								</div>
								...
								<div class="am-form-group">
									...
									<div class="am-u-sm-9">
										<input type="text" id="user-name"
											...
											class="developer" value='${list[0].createtime }' disabled>
										<small>输入开发者名称</small>
									</div>
								</div>
					...
					success : function(data) {
						if (data == 1) {
							...
							$('.am-modal-btn').on('click', function() {
								$(window).attr('location', '/section/index');
							})
